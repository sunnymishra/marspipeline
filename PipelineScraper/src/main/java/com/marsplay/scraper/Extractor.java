...
public abstract class Extractor {
	...
	public WebElement waitAndExtractElement(WebElement elem,
		...
		FluentElementWait wait = new FluentElementWait(elem)
			.withTimeout(Long.parseLong(props.getProperty("endsite.common.element_load_timeout_seconds")), TimeUnit.SECONDS)
			.pollingEvery(Long.parseLong(props.getProperty("endsite.common.element_load_sleep_timeout_millis")), TimeUnit.MILLISECONDS)
